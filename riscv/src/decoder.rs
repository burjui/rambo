...
impl fmt::Debug for Op {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self.0 {
            ...
            rvsim::Op::Jalr { rd, rs1, i_imm } => write!(f, "jalr x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Beq { rs1, rs2, b_imm } => write!(f, "beq x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            rvsim::Op::Bne { rs1, rs2, b_imm } => write!(f, "bne x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            rvsim::Op::Blt { rs1, rs2, b_imm } => write!(f, "blt x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            rvsim::Op::Bge { rs1, rs2, b_imm } => write!(f, "bge x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            rvsim::Op::Bltu { rs1, rs2, b_imm } => write!(f, "bltu x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            rvsim::Op::Bgeu { rs1, rs2, b_imm } => write!(f, "bgeu x{}, x{}, 0x{:x}", rs1, rs2, b_imm),
            ...
            rvsim::Op::Addi { rd, rs1, i_imm } => write!(f, "addi x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Slti { rd, rs1, i_imm } => write!(f, "slti x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Sltiu { rd, rs1, i_imm } => write!(f, "sltiu x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Xori { rd, rs1, i_imm } => write!(f, "xori x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Ori { rd, rs1, i_imm } => write!(f, "ori x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Andi { rd, rs1, i_imm } => write!(f, "andi x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            ...
            rvsim::Op::Csrrwi { rd, zimm, csr } => write!(f, "csrrwi x{}, 0x{:x}, {}", rd, zimm, csr),
            rvsim::Op::Csrrsi { rd, zimm, csr } => write!(f, "csrrsi x{}, 0x{:x}, {}", rd, zimm, csr),
            rvsim::Op::Csrrci { rd, zimm, csr } => write!(f, "csrrci x{}, 0x{:x}, {}", rd, zimm, csr),
            ...
            rvsim::Op::LrW { rd, rs1, aq, rl } => write!(f, "lr.w x{}, x{}, {}, {}", rd, rs1, aq, rl),
            rvsim::Op::ScW { rd, rs1, rs2, aq, rl } => write!(f, "sc.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmoswapW { rd, rs1, rs2, aq, rl } => write!(f, "amoswap.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmoaddW { rd, rs1, rs2, aq, rl } => write!(f, "amoadd.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmoxorW { rd, rs1, rs2, aq, rl } => write!(f, "amoxor.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmoandW { rd, rs1, rs2, aq, rl } => write!(f, "amoand.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmoorW { rd, rs1, rs2, aq, rl } => write!(f, "amoor.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmominW { rd, rs1, rs2, aq, rl } => write!(f, "amomin.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmomaxW { rd, rs1, rs2, aq, rl } => write!(f, "amomax.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmominuW { rd, rs1, rs2, aq, rl } => write!(f, "amominu.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::AmomaxuW { rd, rs1, rs2, aq, rl } => write!(f, "amomaxu.w x{}, x{}, x{}, {}, {}", rd, rs1, rs2, aq, rl),
            rvsim::Op::Flw { rd, rs1, i_imm } => write!(f, "flw x{}, x{}, 0x{:x}", rd, rs1, i_imm),
            rvsim::Op::Fsw { rs1, rs2, s_imm } => write!(f, "fsw x{}, x{}, 0x{:x}", rs1, rs2, s_imm),
            rvsim::Op::FmaddS { rd, rs1, rs2, rs3, rm } => write!(f, "fmadd.s x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FmsubS { rd, rs1, rs2, rs3, rm } => write!(f, "fmsub.s x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FnmsubS { rd, rs1, rs2, rs3, rm } => write!(f, "fnmsub.s x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FnmaddS { rd, rs1, rs2, rs3, rm } => write!(f, "fnmadd.s x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FaddS { rd, rs1, rs2, rm } => write!(f, "fadd.s x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FsubS { rd, rs1, rs2, rm } => write!(f, "fsub.s x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FmulS { rd, rs1, rs2, rm } => write!(f, "fmul.s x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FdivS { rd, rs1, rs2, rm } => write!(f, "fdiv.s x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FsqrtS { rd, rs1, rm } => write!(f, "fsqrt.s x{}, x{}, {}", rd, rs1, rm),
            rvsim::Op::FsgnjS { rd, rs1, rs2 } => write!(f, "fsgnj.s x{}, x{}, x{}", rd, rs1, rs2),
            rvsim::Op::FsgnjnS { rd, rs1, rs2 } => write!(f, "fsgnjn.s x{}, x{}, x{}", rd, rs1, rs2),
            rvsim::Op::FsgnjxS { rd, rs1, rs2 } => write!(f, "fsgnjx.s x{}, x{}, x{}", rd, rs1, rs2),
            ...
            rvsim::Op::Fsd { rs1, rs2, s_imm } => write!(f, "fsd x{}, x{}, 0x{:x}", rs1, rs2, s_imm),
            rvsim::Op::FmaddD { rd, rs1, rs2, rs3, rm } => write!(f, "fmadd.d x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FmsubD { rd, rs1, rs2, rs3, rm } => write!(f, "fmsub.d x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FnmsubD { rd, rs1, rs2, rs3, rm } => write!(f, "fnmsub.d x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FnmaddD { rd, rs1, rs2, rs3, rm } => write!(f, "fnmadd.d x{}, x{}, x{}, {}, {}", rd, rs1, rs2, rs3, rm),
            rvsim::Op::FaddD { rd, rs1, rs2, rm } => write!(f, "fadd.d x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FsubD { rd, rs1, rs2, rm } => write!(f, "fsub.d x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FmulD { rd, rs1, rs2, rm } => write!(f, "fmul.d x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FdivD { rd, rs1, rs2, rm } => write!(f, "fdiv.d x{}, x{}, x{}, {}", rd, rs1, rs2, rm),
            rvsim::Op::FsqrtD { rd, rs1, rm } => write!(f, "fsqrt.d x{}, x{}, {}", rd, rs1, rm),
            rvsim::Op::FsgnjD { rd, rs1, rs2 } => write!(f, "fsgnj.d x{}, x{}, x{}", rd, rs1, rs2),
            rvsim::Op::FsgnjnD { rd, rs1, rs2 } => write!(f, "fsgnjn.d x{}, x{}, x{}", rd, rs1, rs2),
            rvsim::Op::FsgnjxD { rd, rs1, rs2 } => write!(f, "fsgnjx.d x{}, x{}, x{}", rd, rs1, rs2),
